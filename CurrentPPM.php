...
try {
    ...
    $query = "SELECT AVG(CurrentPPMwaarde) AS PPMWaarde FROM (SELECT CurrentPPMwaarde FROM product ORDER BY Tijd DESC LIMIT 30 ) AS subquery;";
    ...
    if ($result->num_rows > 0) {
        ...
        // Gebruik de juiste alias "PPMWaarde" om de waarde op te halen
        echo $row['PPMWaarde'];
    } else {
